...
{
public:
    uint8_t joystickXPin = A0; // Chân analog cho trục X của joystick
    uint8_t joystickYPin = A1; // Chân analog cho trục Y của joystick
    uint8_t buttonPin = 2;     // Chân digital cho nút nhấn
