...
public:
    ...
    bool Get_status_button_1() { return bitRead(Data_MKE_Gamepad.buttons, 0); }
    bool Get_status_button_2() { return bitRead(Data_MKE_Gamepad.buttons, 1); }
    bool Get_status_button_3() { return bitRead(Data_MKE_Gamepad.buttons, 2); }
    bool Get_status_button_4() { return bitRead(Data_MKE_Gamepad.buttons, 3); }
    bool Get_status_button_90D_Left() { return bitRead(Data_MKE_Gamepad.buttons, 4); }
    bool Get_status_button_90D_Right() { return bitRead(Data_MKE_Gamepad.buttons, 5); }
    bool Get_status_Joystick_Button_Left() { return bitRead(Data_MKE_Gamepad.buttons, 6); }
    bool Get_status_Joystick_Button_Right() { return bitRead(Data_MKE_Gamepad.buttons, 7); }
};
